...
This Android application integrates the AutosenseBLE platform into mCerebrum's data collection and processing system.
...
For the versions available, see [this repository's tags](https://github.com/MD2Korg/mCerebrum-AutoSenseBLE/tags).

## Contributors

Link to the [list of contributors](https://github.com/MD2Korg/mCerebrum-AutoSenseBLE/graphs/contributors) who participated in this project.
